...
\subsection{Graph}
\cppfile{data_structures/graph.cpp}
...
\cppfile{classic_problems/sliding_window.cpp}
...
\subsection{Succesor graph}
\cppfile{graph/succesor_graph.cpp}
\subsection{Util}
\cppfile{graph/util_graph.cpp}
\subsection{Edmons Karp}
\cppfile{graph/edmons_karp.cpp}
\subsection{Dinic}
...
\cppfile{tree/binary_jumping.cpp}
\subsection{Lowest Common Ancestor (LCA)}
\cppfile{tree/lowest_common_ancestor.cpp}
